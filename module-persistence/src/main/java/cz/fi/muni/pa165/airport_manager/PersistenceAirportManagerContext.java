...
@ComponentScan(basePackageClasses = {AdminDao.class, ManagerDao.class, AirportDao.class, AirplaneDao.class, FlightDao.class, StewardDao.class}, basePackages = "cz.fi.muni.pa165.airport_manager")
public class PersistenceAirportManagerContext {
